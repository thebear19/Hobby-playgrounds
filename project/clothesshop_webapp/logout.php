...
<body onLoad="JavaScript:timedout(3000);" style="background-image: url(images/BG001.jpg);" bgproperties="fixed" onLoad="init();">
<center>
<div id="container">
<div id="header"></div>
...
<br/>
	...
	<?
		...
		{
			session_destroy();?>
        	<center>ลงชื่อออกเรียบร้อยแล้ว ขอบคุณที่ใช้บริการของทางร้าน<br />
