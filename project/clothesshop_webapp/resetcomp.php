...
<body style="background-image: url(images/BG001.jpg);" bgproperties="fixed" onLoad="JavaScript:timedout(8000);">
<center>
<div id="container">
<div id="header"></div>
...
<br/>
	...
	<?
		if($_SESSION["reset"])
		{?>
        	<center>Password ถูกเปลี่ยนเป็น <? echo $_SESSION["newpass"];?> เรียบร้อยแล้ว<br /><br />
