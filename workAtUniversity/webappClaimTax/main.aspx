<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="main.aspx.cs" Inherits="claim_tax.WebForm1" %>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="height: 14px; width: 171px">
                        <asp:TextBox ID="Labelid" runat="server" Style="font-family: Tahoma; font-size: medium" MaxLength="8" Width="80"></asp:TextBox>
                        <asp:Button ID="Button21" runat="server" Text="ค้นหา" Width="46px" onclick="Search"/>
                    </td>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <asp:Label ID="LabelChild" runat="server" Style="text-align: center" Text="0"></asp:Label>
                    </td>
                    <td style="height: 14px">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <asp:Label ID="LabelChildStudy" runat="server" Style="text-align: center" Text="0"></asp:Label>
                    </td>
                    <td style="height: 14px">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <asp:Label ID="LabelDis" runat="server" Style="text-align: center" Text="0"></asp:Label>
                    </td>
                    <td style="height: 14px">
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td colspan="5">
                        ...
                        &nbsp;&nbsp;&nbsp;<asp:Label ID="LblTextType" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right; width: 80px; height: 20px;">
                        <asp:Label ID="Label13" runat="server" Text="0.00"></asp:Label>
                    </td>
                    <td style="height: 14px">
                ...
                <tr>
                    ...
                    <td style="text-align: right; width: 80px; height: 13px;">
                        <asp:Label ID="Label15" runat="server" Text="0.00"></asp:Label>
                    </td>
                    <td style="height: 14px">
                ...
                <tr>
                    ...
                    <td style="text-align: right; width: 80px; height: 18px;">
                        <asp:Label ID="Label17" runat="server" Text="0.00"></asp:Label>
                    </td>
                    <td style="height: 14px">
                ...
                <tr>
                    ...
                    <td style="text-align: right; width: 80px;">
                        <asp:Label ID="Label19" runat="server" Text="0.00"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="6">
                        <br />
                        <center>
                            <asp:Button ID="Button20" runat="server" Text="ตรวจสอบแล้ว" OnClick="Submit_Click" />
                        </center>
                    </td>
                </tr>
            </table>
