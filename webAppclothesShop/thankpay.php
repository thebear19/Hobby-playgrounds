...
<head>
	...
	<title>Thank You For Paymented</title>
...
<BODY style="background-image: url(images/BG001.jpg);" bgproperties="fixed" onLoad="init();timedout(2000);">
<center>
<div id="container">
<div id="header"></div>
...
<br/>
	<center>
		...
		if($_SESSION["payed"])
		{
        	...
        	<center><img border="0" src = "images/text-Safe.png"/><br />
			<a href="home.php"><img border="0" src = "images/text-ThankBackHome.png"/></a></center>
		<? }
		else
		{
