...
if(isset($_GET[qid]) && !empty($_GET[qid])){
    ...
    if($checkHas == 1){
        ...
        $validDate = new DateTime($row[validdate]);
...
<table width="780" border="0" cellspacing="10" cellpadding="0" align="center" bgcolor="#FFFFFF">
        ...
        <td width="50%">
            <table width="100%" border="0">
                <tr>
                    ...
                    <td><?=$row[creator_company]?></td>
                </tr>
            
                <tr>
                    <td>Address :</td>
                    <td><?=$row[creator_address]?></td>
                </tr>
            ...
            <table width="100%" border="0" cellspacing="5" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" nowrap>
                        <input type="text" class="textbox" name="attention" style="width:210px;" value="<?=$row[attention]?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" class="textbox" style="width:210px;" name="company" value="<?=$row[company]?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <textarea class="textbox" style="width:210px;height:60px;" name="add"><?=$row[addr]?></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" class="textbox" style="width:210px;" name="province" value="<?=$row[province]?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" class="textbox" style="width:160px;" name="zip" value="<?=$row[zip]?>">
                    </td>
                </tr>		
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" class="textbox" style="width:160px;" name="tel" value="<?=$row[tel]?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" class="textbox" style="width:160px;" name="fax" value="<?=$row[fax]?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" class="textbox" style="width:160px;" name="domain" value="<?=$row[DomainName]?>">
                    </td>
                </tr>
                    ...
                    <td valign="top">
                        <select name='customer_type' onchange="holdingTax();">
                            ...
                            foreach ($cusRow as $customer) {
                                $checkCus = ($customer[0] == $clearingRow[CustomerType]) ? "selected" : "";
                    ...
                    <td valign="top">
                        <select name='business_type'>
                            ...
                            foreach ($buRow as $business) {
                                $checkBu = ($business[0] == $clearingRow[BusinessType]) ? "selected" : "";
        ...
        <td width="50%">
            <table width="100%" border="0" cellspacing="5" cellpadding="0">
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" class="textbox" style="width:210px;" name="attention_sale" value="<?=$row[creator]?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top"><?=$tel_us?>
                        &nbsp;Ext&nbsp;
                        <input type="text" class="textbox" style="width:45px;" name="tel_ext" maxlength="4" value="<?=$row[creator_int_number]?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" class="textbox" style="width:140px;" name="directLine" value="<?=$row[direct_line]?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top"><?=$row[issue]?></td>
                </tr>

                <tr>
                    <td valign="top" nowrap><b>Valid Until :</b></td>
                    <td valign="top">
                        <input type="date" name="validUntil" class="textbox" size="25" style="width:140px;" value = "<?=$validDate->format("Y-m-d")?>">
                        <font style="color:#FF0000">*</font>
                    </td>
                </tr>
            </table>
            ...
            <table width="90%" cellpadding="2" cellspacing="0" border="1" bordercolor="#000000" style="border-collapse:collapse;" align="center">
                <tr align="center">
                    ...
                    <td>
                        <div style="font-size:12px;font-weight:bold;">
                            ...
                            if(empty($row[monetary_type])){echo "Baht";}else{echo $row[monetary_type];}?>">)
                        </div>
                    </td>
                </tr>
                ...
                <tr align = "left" valign = "bottom">
                    ...
                    <td valign="top">
                        <select name="service[]" style = "width:450px" onChange = "showPrices(<?=$k?>);showNote(<?=$k?>);">
                            ...
                            <optgroup label = "<?=$producttype?>"> 
                                ...
                                while ($arra = mysql_fetch_array($rsta)){
                                    ...
                                    $check_select = $row["productid$index"]."-$pro_price-$producttype_id-$arra[BOI]-$corporationTax-$officialTax";
                        ...
                        <textarea name='itemNote[]' cols='53' style="display: none" placeholder="Note here..."><?php 
                            echo trim($row["service$index"]);
                        ?></textarea>
                    </td>
	
                    <td colspan='2' valign="top" align='center'>
                        <input type='textbox' align='top' name='price[]' value = '<?=$row["price$index"]?>' style='width:90px;' onclick='calculate(<?=$k?>);calculatesum();holdingTax();' onkeyup='calculate(<?=$k?>);calculatesum();holdingTax();' >
                    </td>
        
                    <td align='center' valign="top">
                        <input type='textbox' name='unit[]' value = '<?=$row["unit$index"]?>' style='width:90px;' onclick='calculate(<?=$k?>);calculatesum();holdingTax();' onkeyup='calculate(<?=$k?>);calculatesum();holdingTax();'>
                    </td>
        
                    <td align='center' valign="top">
                        <input type='textbox' name='amount[]' value = '<?=$row["amount$index"]?>' style='width:110px;' readonly='readonly'>
                    </td>
                </tr>
                ...
                <tr align="center">
                    <td colspan="3" rowspan="5" valign="top">
                        note : <textarea style='padding-left:5px;' name='note' cols='73'><?=$row[note_webpro];?></textarea>
                        
                        <input type="text" name="thaiword" style="width:416px;display: none;"  value = "<?=$row[thaiword]?>">
                ...
                <tr align="center" name="wtTax" style="display: none">
                    <td colspan="2">
                        <div style="font-size:14px;font-weight:bold;" align="left">
                            Withholding Tax <!--(
                            <input type="text" name="wtSpecial" style="width:30px;text-align:center;" value="<?=$row[percent_WT_special]?>" onclick='calTax();' onkeyup='calTax();'>%)-->
                        </div>
                    </td>

                    <td>
                        <input type="text" name="withholdingTax" style="width:110px;" value="<?=$clearingRow[withholding_tax]?>" onclick='calTax();' onkeyup='calTax();'>
                    </td>
                </tr>
                ...
                <tr align="center" name="wtTax" style="display: none">
                    ...
                    <td>
                        <input type="text" name="netAmount" style="width:110px;" value="<?=$clearingRow[netAmount]?>" readonly='readonly'>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <input type="hidden" name="qno" value="<?=$row[qno]?>" />
