        ...
        <tr valign="top">
            <td style="padding-left:10px;">
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                    <tr>
                        <td width="25%" valign="top" nowrap><b>Attention : </b></td>
                    ...
                    <tr>
                        ...
                        <td valign="top"><?=$_POST[poNumber]?></td>
                    </tr>
            ...
            <td>
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                    <tr>
                        <td width='35%' valign='top'><b>Ref no/Quotation no: </b></td>
                        <td valign='top'><?=$_POST[qno]?></td>
                    </tr>

                    <tr>
                        <td width="10%" valign="top"><b>From : </b></td>
                    ...
                    <tr>
                        ...
                        <td valign="top"><?=$invoice->convertDate($_POST[dueDate])?></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
                        ...
                        <tr>
                            <td colspan='8'>
                                ...
                                if ($_POST[withholdingTax] > 0) {
                                    ...
                                    echo "<br> - ในกรณีที่ลูกค้าได้หักภาษี ณ ที่จ่ายไว้ในวันชำระเงิน กรุณาส่งหนังสือรับรองการหัก ณ ที่จ่ายจำนวน 2 ฉบับมายัง บริษัท เรดดี้แพลนเน็ต จำกัด ภายใน 7 วัน <br>
                                    เมื่อทางบริษัทฯ ได้รับหนังสือรับรองการหักภาษี ณ ที่จ่ายถูกต้องครบถ้วนแล้ว จะจัดส่ง \"ใบเสร็จรับเงิน/ใบกำกับภาษี\" ไปให้ลูกค้าทางไปรษณีย์ทันที";
                                }
            ...
            <tr valign="top">
                <td colspan="2">
                    ...
                    <br /><br /><h2><u>ชำระด้วยบัตรเครดิต</u></h2>
                    <br />
                    <table width="70%" cellpadding="0" cellspacing="10" border="0">
                        <tr>
                            <td style="font-size:11px;"><input type="radio" />
                                &nbsp;บัตรเครดิตวีซ่าการ์ด (VISA)</td>
                            <td style="font-size:11px;"><input type="radio" />
                                &nbsp;บัตรเครดิตมาสเตอร์การ์ด (Master Card)</td>
                        </tr>
                        
                        <tr>
                            <td style="font-size:11px;">หมายเลขบัตร........................................................</td>
                            <td style="font-size:11px;">บัตรหมดอายุ............/.............../................</td>
                        </tr>
                        
                        <tr>
                            <td style="font-size:11px;">จำนวนเงิน..................................................</td>
                        </tr>
                        
                        <tr>
                            <td style="font-size:11px;">ลายมือชื่อตามบัตร.................................................</td>
                ...
                <td colspan="2" align="center">
                    ...
                    <table width="90%">
                        <tr height="1" valign="bottom">
                            <td width="55%"><span style="font-size:13px;"></span></td>
                            <td>
                        ...
                        <tr>
                            <td><span style="margin:0 0 0 100;"></span></td>
